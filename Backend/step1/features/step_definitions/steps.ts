...
Given("my fleet", async function () {
  ...
  const createdFleet: Fleet = await createFleetHandler.handle(
    createFleetCommand
  );
...
Given("I have registered this vehicle into my fleet", async function () {
  ...
  await registerVehicleIntoFleetHandler.handle(registerVehicleIntoFleetCommand);
});
...
Then("this vehicle should be part of my vehicle fleet", async function () {
  ...
  const fleetContainsVehicle = await checkIfVehicleIsPartOfAFleetHandler.handle(
...
Then(
  ...
  function () {
    assert(this.error instanceof Error, "The vehicle is already in the fleet");
  }
);
